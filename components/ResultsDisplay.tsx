...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ properties, selectedPropertyId, onSelectProperty }) => {
  if (properties.length === 0) {
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="mt-1 text-sm text-slate-500">Adjust your filters or try a different ZIP code.</p>
      </div>
    );
  }
